...
class LoginPopup extends skydapp_browser_1.FixedNode {
    constructor() {
        super(0, 0);
        this.dom = (0, skydapp_browser_1.el)(".popup-background", this.content = (0, skydapp_browser_1.el)(".login-popup", (0, skydapp_browser_1.el)(".top", (0, skydapp_browser_1.el)("h5", "WELCOME"), (0, skydapp_browser_1.el)("h6", "DISCORD LOGIN IS REQUIRED TO ENTER CLONE CRAFT")), (0, skydapp_browser_1.el)(".content", (0, skydapp_browser_1.el)("a", (0, skydapp_browser_1.el)("img", { src: "/images/icn/discord-white.svg", alt: "discord" }), (0, skydapp_browser_1.el)("p", "LOGIN WITH DISCORD"), {
