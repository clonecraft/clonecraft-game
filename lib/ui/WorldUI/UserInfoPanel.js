...
class UserInfoPanel extends skydapp_browser_1.GameNode {
    constructor() {
        ...
        this.width = 400;
        this.height = 100;
        this.dom = (0, skydapp_browser_1.el)(".user-info-panel", (0, skydapp_browser_1.el)(".profile-image"), (0, skydapp_browser_1.el)(".info-container", (0, skydapp_browser_1.el)("h6", "Clonesneverdie")));
