...
class EmberPanel extends skydapp_browser_1.GameNode {
    constructor() {
        ...
        this.width = 278;
        this.height = 70;
        this.dom = (0, skydapp_browser_1.el)(".ember-panel", (0, skydapp_browser_1.el)("p", skydapp_common_1.SkyUtil.numberWithCommas(ethers_1.utils.formatEther(CloneCraft_1.default.currentUserAmber))));
