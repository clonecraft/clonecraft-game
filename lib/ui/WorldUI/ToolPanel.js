...
const ClonesPopup_1 = __importDefault(require("../../popup/ClonesPopup"));
...
class ToolPanel extends skydapp_browser_1.GameNode {
    constructor() {
        ...
        }), (0, skydapp_browser_1.el)("a.clones", {
            click: () => {
                new ClonesPopup_1.default().appendTo(CloneCraft_1.default.screen.root);
            },
